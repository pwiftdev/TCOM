...
import { TokenSidebar } from '../components/community/TokenSidebar';
...
export default function Community() {
  ...
  const hasToken = Boolean(community?.contract_address);

  return (
    <div className={`community-layout fade-in ${hasToken ? 'has-token' : ''}`}>
      {hasToken && (
        <div className="community-layout-aside">
          <TokenSidebar community={community} />
        </div>
      )}

      <div className="community-layout-feed grid">
        {loadingCommunity && (
